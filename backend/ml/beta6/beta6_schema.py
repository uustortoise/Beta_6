...
_NESTED_SCHEMA_RULES: dict[str, dict[str, str]] = {
    ...
    "beta6_policy_defaults.yaml": {
        ...
        "unoccupied_downsample.prior_drift_guard_rooms": "sequence",
        "minority_sampling.target_share_by_room": "mapping",
        "minority_sampling.max_multiplier_by_room": "mapping",
        "minority_sampling.max_post_sampling_prior_drift_by_room": "mapping",
        "minority_sampling.prior_drift_guard_rooms": "sequence",
        ...
        "training.factorized_primary_rooms": "sequence",
        "training.transition_focus_room_labels": "mapping",
        "training.transition_focus_radius_steps_by_room": "mapping",
        "training.transition_focus_max_multiplier_by_room": "mapping",
        "training.transition_focus_max_post_sampling_prior_drift_by_room": "mapping",
